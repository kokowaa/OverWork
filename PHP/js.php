...
<head>
    ...
    <title>Javascript社区 -- zhanglin.ltd</title>
    <style>
    body{
        margin:0 auto;
    }
...
<body>
    <div class="nav">
            ...
            <br>
            <p style="position: absolute;left:40%;top:15%;color:white;font-size: 53px;"><b>Javascript社区</b></p>
    ...
    <div class="container">
        ...
        <p style="text-align:center;color:blue;font-weight:700;">希望每个人都幸福...</p>
        <div style="text-align:center;"><img src="../image/8.gif" alt="" ></div>
        ...
        <?php
          ...
          {
              // echo "<p>".$row['title']."</p>";
              echo "<div class='card'><div class='card-header bg-info text-white'><span>".$row['id'].".</span> ".$row['title']."</div><div class='card-body' style='width:55%;max-height:48px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;'><a href='showArticle4.php?id=$row[id]' style='color:red;'>".$row['contant']."</a></div></div>";
              echo "<br>";
          }
          }
        ...
        <p style="font-weight:800;">站长真诚祝愿大家平平安安 ，快快乐乐！</p>
    </div>
